...
- `ml_dataset_creator.py`  
  실시간 수집 데이터를 바탕으로 학습용 시퀀스 CSV를 생성합니다. 거래대금 상위 30개 후보 중 변동성 상위 5개 종목을 구독하고, 30초봉 집계 및 feature 계산 후 `dataset/sequence_dataset.csv`에 누적 저장합니다.
...
- CNN-LSTM 학습
- validation macro F1 기준 best model 저장
