...
![Train vs Validation Loss](fig/train_val_loss.png?v=2)

### Train / Validation Macro F1

![Train vs Validation Macro F1](fig/train_val_macro_f1.png?v=2)

### Confusion Matrix

![Confusion Matrix](fig/confusion_matrix.png?v=2)
